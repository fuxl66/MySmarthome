...
if sh.ZS.Notify.Mail() == 1 and sh.WS.TagNacht() == 1: #Nacht
	sh.mail('fuxl@outlook.com', 'Abendbericht', Abend.encode('utf-8'))
#	sh.pushbullet.list("Abendbericht", [sh.WS.Temperatur(), sh.WS.Temperatur.MAX()])
if sh.ZS.Notify.Mail() == 1 and sh.WS.TagNacht() == 0: #Früh
	sh.mail('fuxl@outlook.com', 'Morgenbericht', Morgen.encode('utf-8'))
#	sh.pushbullet.list("Morgenbericht", [sh.WS.Temperatur(), sh.WS.Temperatur.MAX()])
